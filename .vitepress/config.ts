...
export default withMermaid(
  defineConfig({
    ...
    themeConfig: {
        ...
        '/guide/': [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Главная и магазины', link: '/guide/xcourier/home-stores' },
              { text: 'Каталог и товары', link: '/guide/xcourier/products' },
              { text: 'Корзина и оформление заказа', link: '/guide/xcourier/cart-checkout' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Управление заказами', link: '/guide/xcourier-manager/orders' },
              { text: 'Управление товарами', link: '/guide/xcourier-manager/products' },
            ],
          },
          {
            text: 'Админ-панель',
            ...
            items: [
              ...
              { text: 'Обращения', link: '/guide/xcourier-admin/support-tickets' },
      ...
      footer: {
        message: 'Документация проекта xkurier',
